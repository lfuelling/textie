	...
	*/
	...
	private static void initItems() {
		itemMap.put("Karte", new Item("Karte",
				...
				"Du bist in Raum"));
		itemMap.put("Falltür", new Item("Falltür", "Da ist eine Falltür",
		...
		itemMap.put("Schlüssel", new Item(
			"Schlüssel",
